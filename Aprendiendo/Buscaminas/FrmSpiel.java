    ...
    private void cargarControles(){
        ...
        for (int i = 0; i < boardControls.length; i++) {
            for (int j = 0; j < boardControls[i].length; j++) {
                ...
                if (i==0 && j==0){
                    boardControls[i][j].setBounds(posXReferencia, 
                            posYReferencia, anchoControl, altoControl);
                    
                }else if (i==0 && j!=0){
                    boardControls[i][j].setBounds(
                            boardControls[i][j-1].getX()+boardControls[i][j-1].getWidth(), 
                            posYReferencia, anchoControl, altoControl);
                }else{
                    boardControls[i][j].setBounds(
                            boardControls[i-1][j].getX(), 
                            boardControls[i-1][j].getY()+boardControls[i-1][j].getHeight(), 
        ...
        this.setSize(boardControls[numZeilen-1][numSpalten-1].getX()+
