...
public class UI {
	...
	public void hauptmenü() {
		...
		schleife: do {
			...
			System.out.println("3- PrÃ¼fungsergebnis eintragen");
		...
		sc.close();
		/*Wir schliessen unser Scanner, weil wenn der HauptmenÃ¼ geschlossen ist
		 * wÃ¼rde unser Programm zu ende kommen*/
	...
	private void PrüfungsergebnisEintragen() {
		...
		System.out.print("PrÃ¼fungsname: ");
